...
import WebViewer, { Diff } from '@pdftron/webviewer';

import * as S from './styled';

const compareViewer = [
  {
    initialDoc: 'https://s3.amazonaws.com/pdftron/pdftron/example/test_doc_1.pdf',
  ...
  {
    initialDoc: 'https://s3.amazonaws.com/pdftron/pdftron/example/test_doc_2.pdf',
...
//     CompareViewer(compareViewer[0]),
//     CompareViewer(compareViewer[1]),
//   ]);
...
const CompareViewer = () => {
  ...
  useEffect(() => {
    WebViewer(
      ...
      // document.getElementById(`${viewer.domElement}-file-picker`).onchange = (
      //   e
      // ) => {
      ...
      // document.getElementById(`${viewer.domElement}-url-form`).onsubmit = (
      //   e
      // ) => {
      //   e.preventDefault();
      //   instance.loadDocument(
      //     document.getElementById(`${viewer.domElement}-url`).value
      //   );
      // };
    });
  });

  return <S.Webviewer ref={compareDiv}></S.Webviewer>;
};
